...
public class ProductController {
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
    	//test de la gratuité
    	if(product.getPrix() <= 0) throw new ProduitGratuitException("Le produit ne peux pas être gratuit");
    	
    	//le produit n'est pas gratuit : on peut le stocker en base
    ...
    //Calcul des marges sur les produits
    @ApiOperation(value = "Calcul des marges sur les produits")
